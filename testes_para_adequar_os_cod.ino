...
const char* ntpServer[] = {"pool.ntp.org_off", "200.20.186.76_off", "189.45.192.3"}; //200.20 é do ntp br//o 189.45 é da unifique
...
const char* _serverB = "200.20.186.76_off";     //NTP BR          //SERVIDOR NTP SECUNDARIO
const char* _serverP2= "189.45.192.3_OFF";      //PARA TESTES DE DECINCRONISMO //ACABOU FICANADO NO CODIGO! //SERVER PROVEDOR UNIFIQUE
